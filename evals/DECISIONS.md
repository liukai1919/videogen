...
- **推翻条件**：新硬件或新权重下，1080p 直渲在 S1/S2 场景连跑 3 轮无 OOM，
  且单段耗时不劣于"包络渲染+放大"路径。
- **修订(2026-08-11,offload 探针数据)**:包络细化为**乘积预算
  像素×时长 ≤ 864x480×15.5s(≈6.43M px·s),短条封顶 1344x768**
  (官方原生 768 档;`renderer.max_pixels_for_seconds` 单一事实源)。
  证据:960x544/1152x640/1344x768 × 5s 探针分别 242/184/283 秒零 OOM;
  反例 1344x768 × 15s 超时(1800s)+宿主内存见底 4GB。1080p(2.09MP)
  超短条上限,维持禁排。定妆照等短条自此默认可用原生 768 档。
